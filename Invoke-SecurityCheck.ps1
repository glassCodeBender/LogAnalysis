...
Get-EventLog Security | Export-Csv -Path "C:\Users\wobblywudude\Documents\securitylog.csv" -Delimiter '|'
Get-EventLog Application | Export-Csv -Path "C:\Users\wobblywudude\Documents\applog.csv" -Delimiter '|'
Get-EventLog System | Export-Csv -Path "C:\Users\wobblywudude\Documents\systemlog.csv" -Delimiter '|'
